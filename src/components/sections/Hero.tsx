...
export function Hero() {
    return (
        <section
            id="hero"
            className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden px-6 py-24 lg:py-32"
        >
            ...
            <div className="relative max-w-4xl mx-auto text-center w-full">
                ...
                <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top,rgba(139,92,246,0.25)_0%,transparent_60%)] blur-3xl pointer-events-none"></div>

                {/* Status badge */}
                <motion.div
                    className="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-sm text-white/60 font-mono mb-8"
                ...
                >
                    <a
                        href="#projects"
                        className="group relative px-6 py-3 rounded-xl bg-gradient-to-r from-purple-500 to-indigo-500 text-white font-medium transition-all duration-300 hover:scale-105 hover:shadow-[0_0_25px_rgba(139,92,246,0.4)]"
                    >
                    ...
                    <a
                        ...
                        className="flex items-center justify-center gap-2 px-8 py-3 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 hover:border-violet-500/30 text-white/80 hover:text-white font-semibold text-sm transition-all duration-300 hover:scale-105"
                    >
                        <Download size={15} />
                        Resume
                    </a>
